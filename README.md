...
Este projeto explora a intersecção entre criatividade humana e Inteligência Artificial. Utilizando técnicas de **RAG (Retrieval-Augmented Generation)** através do Gemini Gems, foi criado um assistente especializado na análise lírica inspirado em **K-pop e BTS**. O objetivo final foi a produção de um EP com 5 faixas inéditas, cujas letras foram geradas pela IA e a produção musical realizada via Suno AI.
...
O assistente (Gems) utilizado para modelagem das letras pode ser acedido através do link de configuração abaixo:
> [Link para o meu Gemini Gems](https://gemini.google.com/gem/1V6EKFa7B1diX1tTiyEK2e6brTifK6X5p?usp=sharing)
...
| 02 | Blueprints do Ontem | Lo-fi K-pop / Chill R&B | [Ouvir MP3](./audio/Blueprints_do_Ontem.mp3) |
...
2. **Prompt Engineering:** Configuração das instruções do Gems para mimetizar o vocabulário, métrica e sentimentalismo do K-pop.
